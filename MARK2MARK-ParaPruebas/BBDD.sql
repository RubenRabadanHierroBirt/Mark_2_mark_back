...
-- ----------------------------
-- Table structure for resistros_club
-- ----------------------------
DROP TABLE IF EXISTS `resistros_club`;
CREATE TABLE `resistros_club`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_competicion` int(11) NOT NULL,
  `id_club` int(11) NOT NULL,
  ...
  INDEX `competition_id`(`id_competicion`) USING BTREE,
  INDEX `club_id`(`id_club`) USING BTREE,
  CONSTRAINT `resistros_club_ibfk_1` FOREIGN KEY (`id_competicion`) REFERENCES `competiciones` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `resistros_club_ibfk_2` FOREIGN KEY (`id_club`) REFERENCES `clubs` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `resultados`  (
  ...
  CONSTRAINT `resultados_ibfk_2` FOREIGN KEY (`id_atleta`) REFERENCES `atletas` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
